...
var alerted = false;
        ...
        for(let t = 0; t<soundArr.length; t++){  
            ...
            //FOR DAC SOUND
            soundArrDAC[t] = ((digitalToAnalog(Vlsbp, returnVal2Sound)));
        }  }
        else{
            // FOR ALERT
       var alerted = false;
...
let headerAdc = [];
    var values = [];
        headerAdc = [["<b>n</b>"],["<b>Sampling Time</b>"], ["<b>Sampling Values</b>"], ["<b>Quantized Values</b>"], ["<b>PCM Codes</b>"]]
        values = [
            nValForTable,
            xValues,
            yValues,
...
let headerArr = [["<b>n</b>"],["<b>Sampling Time</b>"],["<b>PCM Codes</b>"], ["<b>Reconstructed Values</b>"],];
